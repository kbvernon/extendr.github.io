...
title: Functions
description: >-
  Declare typed functions with fn — typed arguments, declared return types, and
  Rust's expression-based implicit returns.
weight: 8
slug: functions
---
...
Identifying whether a number is odd or even is a classic example. The [is-odd
